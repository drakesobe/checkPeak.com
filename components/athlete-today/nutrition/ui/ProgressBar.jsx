...
export default function ProgressBar({
  ...
  return (
    <div
      className={cx("rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden", padCls)}
      role="progressbar"
      aria-label={label}
      aria-valuemin={0}
      aria-valuemax={100}
    ...
    >
      ...
      <div className={cx("w-full rounded-full bg-gray-100 overflow-hidden", hCls)}>
        <div
          className="h-full rounded-full transition-all duration-300"
          style={{ width: `${w}%`, backgroundColor: isDone ? "#059669" : "#1E3A5F" }}
        />
      </div>
