...
import {
  Droplets, Utensils, RefreshCcw, ArrowRight,
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Mobile-only: single icon refresh */}
        <button
          type="button"
          onClick={refresh}
          disabled={loading}
      ...
      <div className="p-3 sm:p-4">
        ...
        <div className="grid grid-cols-2 gap-px" style={{ backgroundColor: DS.border }}>
          ...
          <div className="p-3" style={{ backgroundColor: DS.pageBg }}>
            ...
            <p className="text-xs mt-1" style={{ color: DS.dimText }}>
              {hydrationSetCount}/{total} athletes
            </p>
          </div>
        </div>
        ...
        {!loading && !err && needsList.length > 0 && (
          <div className="mt-3">
            ...
            <div
              className="space-y-1"
              style={{ maxHeight: 280, overflowY: needsList.length > 4 ? "auto" : "visible" }}
            >
              {preview.map((a) => (
                <div
                  key={a.token || a.email}
                    ...
                    {onViewAthleteNutrition && (
                      <>
                        ...
                        <button
                          ...
                          aria-label="View athlete nutrition"
                        >
                    ...
                    {onBuildNutritionPlan && (
                      <>
                        ...
                        <button
                          ...
                          className="sm:hidden px-2 py-1.5 text-xs font-black uppercase"
                          style={{
