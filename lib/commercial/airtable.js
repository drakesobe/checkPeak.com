...
const TABLES = {
  ...
  completions:  process.env.VIDEO_COMPLETIONS_TABLE_ID,   // VideoCompletions table
};
...
// ─── Completions ──────────────────────────────────────────────────────────────
// Requires VIDEO_COMPLETIONS_TABLE_ID env var.
// Add to .env.local: VIDEO_COMPLETIONS_TABLE_ID=tblXXXXXXXX
// Get the table ID from the Airtable URL when viewing your VideoCompletions table.
