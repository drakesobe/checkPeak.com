...
export default function ScansPage() {
  ...
  useEffect(() => {
    ...
    // TODO: fetch scans for this user from Airtable or API
    // For now, we keep placeholder empty
    setScans([]);
  }, [user, router]);
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-blue-50 font-sans">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-600 mb-6">
          Here you can view all your scans. This page is currently a placeholder.
        </p>
        ...
        {scans.length === 0 ? (
          ...
          <div className="space-y-4">
            {scans.map((scan) => (
              <div
                key={scan.id}
                className="border rounded-2xl p-6 bg-white shadow-md flex justify-between items-center"
              >
                <div>
